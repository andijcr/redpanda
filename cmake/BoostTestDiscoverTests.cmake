...
function(boosttest_discover_tests TARGET)
  ...
  cmake_parse_arguments(
    "_"
    "SKIP_DISABLED_TESTS"
    "TARGET_FILE;WORKING_DIRECTORY;TEST_PREFIX;TEST_SUFFIX;TEST_NAME_SEPARATOR;TEST_LIST;DISCOVERY_TIMEOUT;DISCOVERY_MODE"
    "EXTRA_ARGS;PROPERTIES"
    ${ARGN}
  )

  if(NOT __TARGET_FILE)
    set(__TARGET_FILE $<TARGET_FILE:${TARGET}>)
  endif()
  ...
  if(__DISCOVERY_MODE STREQUAL "POST_BUILD")
    ...
    add_custom_command(
      ...
      COMMAND "${CMAKE_COMMAND}"
              ...
              -D "TEST_EXECUTABLE=\"$(__TARGET_FILE}\""
  ...
  elseif(__DISCOVERY_MODE STREQUAL "PRE_TEST")
    ...
    string(CONCAT ctest_include_content
      ...
      "  if(\"${__TARGET_FILE}\" IS_NEWER_THAN \"${ctest_tests_file}\")"   "\n"
      "    include(\"${__BOOSTTEST_DISCOVER_TESTS_SCRIPT}\")"                      "\n"
      "    boosttest_discover_tests_impl("                                         "\n"
      "      TEST_TARGET"            " [==[" "${TARGET}"                  "]==]"   "\n"
      "      TEST_EXECUTABLE"        " [==[" "${__TARGET_FILE}"   "]==]"   "\n"
